const main = document.getElementById("main"),
    ...
    maoyeedy = document.getElementById("name"),
    redButton = document.getElementById("red-button-placeholder"),
    ...
    scrollPercentage = (window.innerHeight / 100) * 46;

function setColor(e) {
    (circle1.style.backgroundColor = e ? "#93969f" : "white"),
        (circle2.style.backgroundColor = e ? "white" : "#93969f");
}
function scrollMain(e) {
    (main.scrollTop += e ? scrollPercentage : -1 * scrollPercentage), setColor(e);
}
...
function loadDeferContent() {
    document.querySelectorAll(".defer img").forEach(function (e) {
        e.src = e.dataset.src;
    });
}
...
circle1.addEventListener("click", function () {
    ...
    document.addEventListener("keydown", function (e) {
        "ArrowDown" === e.key || "ArrowRight" === e.key ? scrollMain(!0) : ("ArrowUp" !== e.key && "ArrowLeft" !== e.key) || scrollMain(!1);
    }),
